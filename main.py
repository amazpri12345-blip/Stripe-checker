...
API_ID = 39406661
API_HASH = '88a7ac52cfef3dd7a7621f8d62880c8e'
BOT_TOKEN = '8777431371:AAGbOfy7_CKB_-NuZ9BTE_W6N9tXLa5foUo'
ADMIN_ID =  7218406158
KEY_ADMINS = {7218406158}
# ============================================================
# GLOBAL VARIABLES
# ============================================================
...
CHANNEL_USERNAME = "THENETWORKOFJAY"        
# File paths
...
<b>🦄 𝗕𝗼𝘁 𝗕𝘆 ➜ <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a></b>"""
...
🦄 <b>Bot By: <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a></b>"""
...
🔄 <b>GET PREMIUM</b>
Contact <a href="tg://user?id=5237309941">@Nexus_G2</a> for keys
...
<b>✅ Joined: {joined}</b>
━━━━━━━━━━━━━━━━━━━━
<b>👑 Dev: <a href="tg://user?id=7218406158"> ̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a></b>
━━━━━━━━━━━━━━━━━━━━
<b>👇 Select an option below:</b>"""
        ...
        main_buttons = [
            ...
            [
                Button.url("  𝙐𝙋𝘿𝘼𝙏𝙀𝙎 📣  ", f"https://t.me/+_PfswlalZuQ0MDQ9"),
                Button.url("  𝙂𝙍𝙊𝙐𝙋 💭  ", f"https://t.me/THENETWORKOFJAY"),
            ],
        ]
...
<b>⚠️ Dono channel join karo fir verify karo!</b>"""
        ...
        join_buttons = [
            [Button.url(" 𝙂𝙍𝙊𝙐𝙋 💭 ", f"https://t.me/THENETWORKOFJAY")],
            [Button.url(" 𝙐𝙋𝘿𝘼𝙏𝙀𝙎 📣 ", "https://t.me/+_PfswlalZuQ0MDQ9")],
...
async def verify_handler(event):
    ...
    # Channel 2 check
    try:
        ch2 = await bot.get_entity("https://t.me/+_PfswlalZuQ0MDQ9")  # Ya tera channel entity
...
━━━━━━━━━━━━━━━━━━━━
<b>📞 Contact Owner:</b>
<b>👑 <a href="tg://user?id=7218406158">@Nexus_G2</a></b>
━━━━━━━━━━━━━━━━━━━━
<b>💳 Payment:</b>
<b>• UPI • PayPal • Crypto</b>"""
    ...
    support_buttons = [
        [
            Button.url("𝘽𝙐𝙔 𝙋𝙇𝘼𝙉", f"https://t.me/Nexus_G2"),
            Button.url("𝘾𝙊𝙉𝙏𝘼𝘾𝙏 𝙊𝙒𝙉𝙀𝙍", f"https://t.me/Nexus_G2"),
        ],
        [
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Contact: <a href="tg://user?id=7218406158">@Nexus_G2</a></b>"""

    plan_buttons = [
        [Button.url("💎 BUY NOW", f"https://t.me/Nexus_G2")],
        [Button.inline("🔙 𝘽𝘼𝘾𝙆", b"back_to_start")],
    ]
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Owner: <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a></b>"""
...
<b>👑 Buy: <a href="tg://user?id=7218406158">@Nexus_G2</a></b>"""
...
━━━━━━━━━━━━━━━━━━━━
<b>💎 Upgrade: <a href="tg://user?id=7218406158">@Nexus_G2</a></b>
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Get Key: <a href="tg://user?id=7218406158">@Nexus_G2</a></b>"""), parse_mode="html")
        return
...
<b>👑 Contact: <a href="tg://user?id=7218406158">@Nexus_G2</a></b>"""), parse_mode="html")
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 Fresh Key: <a href="tg://user?id=7218406158">@Nexus_G2</a></b>
...
🦄 Bot By: <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a>"""
...
━━━━━━━━━━━━━━━━━━━━
<b>👑 𝗕𝘆 ➜ <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a></b>"""
...
✅ 𝐔𝐬𝐞𝐫 ↬ <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a>
...
👑 𝐂𝐡𝐞𝐜𝐤𝐞𝐝 𝐁𝐲 ↬ <a href="tg://user?id=7218406158">ℒℯℴ ♔</a>

🦄 Bot By: <a href="tg://user?id=7218406158">ℒℯℴ ♔</a>"""
            ...
            try:
                # Group bhejo
                msg = await bot.send_message("THENETWORKOFJAY", premium_emoji(group_msg), parse_mode='html', buttons=group_buttons, silent=True)
                await bot.send_reaction("THENETWORKOFJAY", msg.id, "💎")
                
                # DM bhejo
                await bot.send_message(7218406158, premium_emoji(dm_msg), parse_mode='html', buttons=dm_buttons)
...
👤 𝐔𝐬𝐞𝐫 ↬ <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a> [👑 Admin]
🦄 𝐇𝐢𝐭 𝐅𝐫𝐨𝐦 ↬ @Shopixrzr_bot"""
...
👑 𝐂𝐡𝐞𝐜𝐤𝐞𝐝 𝐁𝐲 ↬ <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a>
...
🦄 Bot By: <a href="tg://user?id=7218406158">̲𝑵̲𝑬̲𝑿̲𝑼̲𝑺̲ ̲ ̲𝑮̲𝑨̲𝑴̲𝑰̲𝑵̲𝑮̲ ᯓ ✈︎</a>"""
            ...
            try:
                # Group bhejo
                await bot.send_message("THENETWORKOFJAY", premium_emoji(group_msg), parse_mode='html', buttons=group_buttons, silent=True)
...
<b>👑 DM:</b> <a href="tg://user?id=7218406158">@Nexus_G2</a>
━━━━━━━━━━━━━━━━━━━━
...
🦄 𝐇𝐢𝐭 𝐅𝐫𝐨𝐦 ↬ @Shopixrzr_bot"""
        ...
        try:
            ...
            await bot.send_reaction("THENETWORKOFJAY", msg.id, emoji)
        except:
            pass
